...
export function HomePage() {
  ...
  return (
    <div className="page-stack">
      ...
      {/* 1. Module 1+2: Merged contextual section */}
      ...
      {/* 3. Module 3: Your community needs you */}
      ...
      {(() => {
        ...
        const categoryCards = userInterests.map((cat) => {
          const categoryTerms = [cat.toLowerCase(), ...({ Skincare: ['skincare','skin','serum','moisturiser','sunscreen','toner','cleanser'], Makeup: ['makeup','foundation','concealer','lipstick','blush','eyeshadow','mascara'], Haircare: ['hair','haircare','frizz','shampoo','conditioner','scalp','hair fall'], Nailcare: ['nail','nails','nail polish','nailcare','manicure'], Fragrance: ['fragrance','perfume','mist','scent','attar'], 'Lip care': ['lip','lips','lip balm','lip care','lip oil'] }[cat])]
      ...
      {/* 8. Expert spotlight — Hear from our experts */}
      {(() => {
